cordova.define("cordova-plugin-background-mode.BackgroundMode", function(require, exports, module) {
	...
	*/
	...
	exports.startGettingBackgroundLocation = function(params, successCallback, errCallback)
	{
		...
		console.log('startGettingBackgroundLocation');
		...
		cordova.exec(successCallback, errCallback, 'BackgroundMode', 'starttracking', [interval, afterLastUpdateMinutes, minimumDistanceChanged]);
	};
	/**
